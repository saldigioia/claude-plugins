...
## 9. Loudness normalization is not mastering

EBU R128 (the LUFS measurement standard) is a *measurement* discipline, designed for broadcast loudness consistency. It tells you how loud something is. It does not tell you that something should *be* a particular loudness. The mix bus is not the place to chase -14 LUFS to match Spotify's normalization target — that's a mastering-stage decision involving limiting, EQ, and creative judgment about what the song should feel like.

**Behavioral consequence:** The skill measures LUFS-I, LUFS-S, and LRA. It does not normalize to any LUFS target. Period.
